...
namespace kitronik_simple_servo {
    ...
    //% block="set servo motor %servoSelection angle to %degrees degrees"
    //% color=#00A654
    ...
    //% block="set servo motor %servoSelection to central position"
    //% color=#00A654
    ...
    //% block="stop servo motor %servoSelection"
    //% color=#00A654
    //% weight=100 blockGap=8
